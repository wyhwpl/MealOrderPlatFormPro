...
function  allFood(data) {
    ...
    $.ajax({
        ...
        success:function (result) {
            ...
            var $tbody=$("#tab_3_0 tbody");
            var $page=$(".page3");
            var $pageInfo=$(".page3 .page-info");
            var $pageNav=$(".page3 .page_3_0 ul");
            var $pageNavDiv=$(".page3 div");
            ...
            for (var i=0;i<result.list.length;i++) {
                var regtime=new Date(result.list[i].applicationtime);
                ...
                var elem="<tr>" +
                    ...
                    "<td>"+result.list[i].foodname+"</td>"+
                    "<td>"+result.list[i].description+"</td>"+
                    "<td>"+regtime.getFullYear()+"年"+regtime.getMonth()+"月"+regtime.getDate()+"日"+"</td>"+
                    "<td>"+status+"</td>"+
                    "<td><a href='#foodModal' data-toggle='modal' data-id='"+
                    result.list[i].id+"' data-seller='"+result.list[i].sellerid+"' data-tag='"+
                    result.list[i].tagid+"'>详情</a></td>"+
                    "</tr>";
...
/*为元素绑定监听实践*/
function bindEvenAll_food(result) {

    console.log("监听");
    console.log(result);
    var $pageNav=$(".page3 .page_3_0 ul li a");
    console.log($pageNav);
    for (var i = 0; i <$pageNav.length ; i++) {
        var $ele=$pageNav.eq(i);
        var name=$ele.data("name");
        console.log(name);
        var $pageUl=$(".page3 .page_3_0 ul");
...
function auditFood(data) {
    $.ajax({
        ...
        success:function (result) {
            ...
            var $tbody=$("#tab_3_1 tbody");
            var $page=$(".page3");
            var $pageInfo=$(".page3 .page-info");
            var $pageNav=$(".page3 .page_3_1 ul");
            var $pageNavDiv=$(".page3 div");
...
/*为元素绑定监听实践*/
function bindEvenAudit_food(result) {
    console.log("监听");
    console.log(result);
    var $pageNav=$(".page3 .page_3_1 ul li a");
    console.log($pageNav);
    for (var i = 0; i <$pageNav.length ; i++) {
        var $ele=$pageNav.eq(i);
        var name=$ele.data("name");
        console.log(name);
        var $pageUl=$(".page3 .page_3_1 ul");
        $pageUl.on("click",$ele,function () {
            var data;
            if(name=="first"){
                data="pageNum="+1+"&&pageSize="+result.pageSize;
...
function notAuditFood(data) {
    $.ajax({
        ...
        success:function (result) {
            ...
            var $tbody=$("#tab_3_2 tbody");
            var $page=$(".page3");
            var $pageInfo=$(".page3 .page-info");
            var $pageNav=$(".page3 .page_3_2 ul");
            var $pageNavDiv=$(".page3 div");
...
/*为元素绑定监听实践*/
function bindEvenNotAudit_food(result) {
    console.log("监听");
    console.log(result);
    var $pageNav=$(".page3 .page_3_2 ul li a");
    console.log($pageNav);
    for (var i = 0; i <$pageNav.length ; i++) {
        var $ele=$pageNav.eq(i);
        var name=$ele.data("name");
        console.log(name);
        var $pageUl=$(".page3 .page_3_2 ul");
        $pageUl.on("click",$ele,function () {
            var data;
            if(name=="first"){
                data="pageNum="+1+"&&pageSize="+result.pageSize;
...
function thoughFood(data) {
    $.ajax({
        ...
        success:function (result) {
            ...
            var $tbody=$("#tab_3_3 tbody");
            var $page=$(".page3");
            var $pageInfo=$(".page3 .page-info");
            var $pageNav=$(".page3 .page_3_3 ul");
            var $pageNavDiv=$(".page3 div");
...
/*为元素绑定监听实践*/
function bindEvenThough_food(result) {
    console.log("监听");
    console.log(result);
    var $pageNav=$(".page3 .page_3_3 ul li a");
    console.log($pageNav);
    for (var i = 0; i <$pageNav.length ; i++) {
        var $ele=$pageNav.eq(i);
        var name=$ele.data("name");
        console.log(name);
        var $pageUl=$(".page3 .page_3_3 ul");
        $pageUl.on("click",$ele,function () {
            var data;
            if(name=="first"){
                data="pageNum="+1+"&&pageSize="+result.pageSize;
...
function notThoughFood(data) {
    $.ajax({
        ...
        success:function (result) {
            ...
            var $tbody=$("#tab_3_4 tbody");
            var $page=$(".page3");
            var $pageInfo=$(".page3 .page-info");
            var $pageNav=$(".page3 .page_3_4 ul");
            var $pageNavDiv=$(".page3 div");
...
/*为元素绑定监听实践*/
function bindEvenNotThough_food(result) {
    console.log("监听");
    console.log(result);
    var $pageNav=$(".page3 .page_3_4 ul li a");
    console.log($pageNav);
    for (var i = 0; i <$pageNav.length ; i++) {
        var $ele=$pageNav.eq(i);
        var name=$ele.data("name");
        console.log(name);
        var $pageUl=$(".page3 .page_3_4 ul");
        $pageUl.on("click",$ele,function () {
            var data;
            if(name=="first"){
                data="pageNum="+1+"&&pageSize="+result.pageSize;
